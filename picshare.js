...
var $author$project$Picshare$init = {
	caption: 'Surfing',
...
var $author$project$Picshare$ToggleLiked = {$: 'ToggleLiked'};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$Picshare$ToggleLiked)
					]),
				_List_Nil)
			]));
};
...
var $author$project$Picshare$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Picshare$init, update: $author$project$Picshare$update, view: $author$project$Picshare$view});
